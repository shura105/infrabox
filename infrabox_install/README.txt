...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  0_probe.sh      ПЕРШИЙ крок. Тонкий автономний збирач ДАНИХ про вузол:
                  ...
                  + ВЖЕ ВСТАНОВЛЕНІ infrabox-підсистеми (наявні контейнери)
...
Природний порядок — спершу факти, потім план. Поділ відповідальності:
  ...
  • 1_prepare = РІШЕННЯ адміна: розподіл ролей — ДЕФОЛТ = вже встановлена схема
    (виявлена probe); адмін лише вносить зміни (додати/перенести/прибрати).
    Підказка придатності за фактами + SSH/deploy_dir/repo/branch — і збірка плану
